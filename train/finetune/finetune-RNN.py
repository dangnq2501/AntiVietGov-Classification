...
class RNNmodel(nn.Module):
    def __init__(self,hidden_size = 32,num_layers = 3, bidirectional = False):
        ...
        self.rnn = nn.RNN(input_size = matrix_size[1],hidden_size = hidden_size,
...
def optuna_training(model : nn.Module,
    ...
    #print('#################################################################')
    #print(f'Trial number {num_trial} #######################################')
    #print('#################################################################')
...
def objective(trial):
    ...
    model = RNNmodel(hidden_size = hidden_size, num_layers = num_layer, 
